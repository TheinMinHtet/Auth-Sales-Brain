...
function LoginForm() {
  ...
  const [error, setError] = useState(() => {
    if (!authError) return "";
    if (authError === "auth_callback_failed") return "Google sign-in failed. Try again.";
    if (authError === "missing_auth_code") return "Sign-in was interrupted. Please try again.";
    try {
  ...
  return (
    <div className="w-full max-w-md space-y-4 rounded-2xl border bg-white p-8 shadow-sm">
      ...
      <p className="text-sm text-slate-500">Welcome back to AI Shop Bot Platform</p>
